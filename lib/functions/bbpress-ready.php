...
add_action( 'genesis_title', 'cuttz_bbpress_init' );
add_filter( 'genesis_pre_get_option_site_layout', 'cuttz_bbpress_layout' );
...
function cuttz_bbpress_layout( $layout ) {
	...
	$set = ( $set == 'default' ) ? $layout : $set; // if no setting in Cuttz defined then use Genesis setting
